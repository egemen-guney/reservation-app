...
export default function MenuEditor() {
  ...
  const handleDeleteItem = async (menuItemId) => {
    if (!window.confirm("Are you sure you want to completely remove this item from your menu?")) {
      return;
    }
      ...
      <main className="p-4 max-w-3xl mx-auto space-y-6 mt-4">
        ...
        <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-200">
          ...
          <form onSubmit={handleAddItem} className="space-y-4">
            ...
            {/* Adjusted grid since Satisfaction is gone */}
                ...
                <div key={item.menuItemId} className="flex justify-between items-start bg-white p-4 rounded-xl border border-gray-200 shadow-sm relative overflow-hidden">
                  ...
                  <div className="pl-2">
                    ...
                    <div className="flex gap-4 mt-2 text-sm font-bold items-center">
                      ...
                      {/* Changed to "No ratings yet" fallback */}
                  ...
                  <button onClick={() => handleDeleteItem(item.menuItemId)} className="text-red-500 font-bold hover:bg-red-50 px-3 py-2 rounded-lg transition">Delete</button>
                </div>
              );
            })}
          </div>
