...
export default function Login() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // This will log the exact backend error to your browser console!
  ...
  return (
    // Tailwind classes make this instantly mobile responsive!
    <div className="min-h-screen flex items-center justify-center bg-gray-50 p-4">
      <div className="max-w-md w-full space-y-8 bg-white p-8 rounded-2xl shadow-lg">
        <h2 className="text-center text-4xl font-extrabold text-blue-600">ResApp</h2>
        <p className="text-center text-gray-500 font-medium">Sign in to your account</p>
        
        {error && <div className="bg-red-50 text-red-500 p-3 rounded-lg text-sm text-center font-semibold">{error}</div>}
        ...
        <div className="relative flex items-center">
          ...
          <button 
            type="submit" 
            className="w-full bg-blue-600 hover:bg-blue-700 text-white font-bold py-4 rounded-xl active:scale-95 transition-all shadow-md"
          >
            Sign In
          </button>
        </form>
